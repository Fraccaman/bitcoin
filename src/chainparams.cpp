...
public:
    CMainParams() {
        ...
        // maybe instead of changing the difficulty we can change the time it takes to recompute it
        ...
        // Seeds are not needed due to the fact that we are working with our local nodes
        ...
        // NEW: Modify checkpointData in order to make it run from block 1
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 1, uint256S("0x00000000839a8e6886ab5951d76f411475428afc90947ee320161bbf18eb6048"))
        };

        // NEW: Data here are useless since they are not checked anymore
        chainTxData = ChainTxData {
            // Data as of block 00000000000000000166d612d5595e2b1cd88d71d695fc580af64d8da8658c23 (height 446482).
            1231469744, // * UNIX timestamp of last known number of transactions
